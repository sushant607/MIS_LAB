...
describe("Unit Testing with Mocha/Chai: Ticket API", function () {
  this.timeout(5000);

  before(() => {
    // 🔥 Replace POST /api/tickets logic with mock to isolate unit logic
  ...
  it("should FAIL when title is missing", async () => {
    ...
    expect(res.body.msg).to.equal("Title required");
  });
});
